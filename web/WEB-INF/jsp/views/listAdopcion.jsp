            ...
            <table class="table">
                ...
                <tbody>
                    <c:forEach items="${adopt}" var="datos">
                        <tr>
                            <th><c:out value="${datos.adopt_id}"></c:out></th>
                            <td><c:out value="${datos.nombre}"></c:out></td>
                            <td><c:out value="${datos.petNombre}"></c:out></td>
                            <td><c:out value="${datos.adopt_date}"></c:out></td>
                                <td>
                                    <a href="updateAdopcion.htm?id=${datos.adopt_id}" class="btn btn-warning" style="border-radius: 13px;"><img src="https://img.icons8.com/ios/50/000000/pencil.png" width="25px"/></a>
                                    <a href="deleteAdopcion.htm?id=${datos.adopt_id}" class="btn btn-danger" style="border-radius: 13px;"><img  src="https://img.icons8.com/ios/50/000000/delete--v1.png" width="25px" /></a>
                            </td>
                        </tr>    
                    </c:forEach>
                    <tr>
